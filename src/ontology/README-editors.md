...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/cmungall/triffo) for details.
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/triffo_terms.txt file
...
Note: the triffo_terms.txt file may include 'starter' classes seeded from
 ...
 * https://github.com/cmungall/triffo/releases
 * https://github.com/cmungall/triffo/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/cmungall/triffo.svg?branch=master)](https://travis-ci.org/cmungall/triffo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/cmungall](https://travis-ci.org/profile/cmungall)
